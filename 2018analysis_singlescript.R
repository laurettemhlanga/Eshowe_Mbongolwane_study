...
write.csv(bootstrap_incidence, "/home/laurette/Desktop/Github/msfanalysis20211110/newoutputdata/2018bootsonemodel_sd")
...
ggplot()+
  ...
  scale_y_continuous(limits=c(0,0.12), breaks = round(seq(0,0.1,0.02), digits = 3))+
  theme(legend.position = "bottom")

ggsave("/home/laurette/Dropbox/MhlangaWelteDeltaInc2020S2/MSFdataset/updatefigures20211020/maleplots/2018singlesurvey.png", w = 15, h = 10)
