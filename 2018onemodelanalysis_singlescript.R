...
midpoint <- 2018; predicttimes <- 2018
...
bootstrap_strategy = "2018"


msfdata2018mod <- msfdata2018_mod %>% 
  filter(sex == "Male")

msfdata <-  msfdata2018mod
...
bootstrap_incidence <- foreach(index = seq_along(1:surveyiterations), 
           ...
           analysis_data <- bootstrap_data(data_2013  = NULL, 
...
write.csv(bootstrap_incidence, "/home/laurette/Desktop/Github/msfanalysis20211110/newoutputdata/males/2018kznonemodel_sd")
...
# write.csv(sde, "/home/laurette/Desktop/Github/msfanalysis20211110/newoutputdata/males/2018kznonemodel_sd")

sde <- read.csv("/home/laurette/Desktop/Github/msfanalysis20211110/newoutputdata/males/2018kznonemodel_sd")
...
inc_estimate <- incestimate %>% 
  ...
  mutate(incidenceo = (incidencem*weight) + 
           ((1 - weight)*incidencek )) %>% 
  select(age, dates, prevalence,incidencem,  incidencek, incidenceo)


write.csv(inc_estimate, "/home/laurette/Desktop/Github/msfanalysis20211110/newoutputdata/males/2018kznonemodel_est")
...
ggsave("/home/laurette/Dropbox/MhlangaWelteDeltaInc2020S2/MSFdataset/updatefigures20211020/Maleplots/2018estimates.png", w = 15, h = 10)
