...
reclink = "cloglog"; MDRI = 217; FRR = 0.001667
RSE_MDRI = 0.01 ; RSE_FRR = 0.25; 
epsi <- (MDRI/365.25)/2; BigT = 730
midpoint <- 2013; predicttimes <- 2013
...
write.csv(bootstrap_incidence, "/home/laurette/Desktop/Github/msfanalysis20211110/newoutputdata/males/2013bootsonemodel_sd")
...
write.csv(sde, "/home/laurette/Desktop/Github/msfanalysis20211110/newoutputdata/males/2013kznonemodel_sd")
...
ggsave("/home/laurette/Dropbox/MhlangaWelteDeltaInc2020S2/MSFdataset/updatefigures20211020/maleplots/2013singlesurvey.png", w = 15, h = 10)
